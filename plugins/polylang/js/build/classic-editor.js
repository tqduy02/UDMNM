...
jQuery(function ($) {
    ...
    dialogResult.then(
      () => {
        ...
        $.post(ajaxurl, data, function (response) {
          ...
          $.each(res.responses, function () {
            switch (this.what) {
              ...
              case "taxonomy": // categories metabox for posts
                ...
                $("#new" + tax + "_parent").replaceWith(
                  this.supplemental.dropdown,
                ); // phpcs:ignore WordPressVIPMinimum.JS.HTMLExecutingFunctions.replaceWith
          ...
          const onPostLangChoice = new CustomEvent("onPostLangChoice", {
            detail: {
              lang: JSON.parse(
  ...
  document.addEventListener("onPostLangChoice", (e) => {
    ...
    $("#content_ifr")
      .contents()
      .find("html")
      .attr("lang", e.detail.lang.locale)
      .attr("dir", dir);
