...
jQuery(function ($) {
  ...
  function add_flag(widget) {
    ...
    widget = $(widget);
    var title = isBlockEditor
        ? widget.prev("h3")
        : $(".widget-top .widget-title h3", widget),
  ...
  $(
    ".widgets-sortables,.control-section-sidebar,.edit-widgets-main-block-list",
  ).on("change", ".pll-dropdown", function () {
    var this_id = $(this)
      .parent()
      .parent()
      .parent()
