  ...
  const handleQuickEditInsertion = (mutationsList) => {
    for (const mutation of mutationsList) {
      ...
      if (
        ...
        form.classList.contains("inline-edit-row")
      ) {
...
jQuery(function ($) {
  ...
  $("#term_lang_choice").on("change", function () {
    ...
    $.post(ajaxurl, data, function (response) {
      ...
      const onTermLangChoice = new CustomEvent("onTermLangChoice", {
        detail: {
          lang: JSON.parse(
  ...
  document.addEventListener("onTermLangChoice", (e) => {
