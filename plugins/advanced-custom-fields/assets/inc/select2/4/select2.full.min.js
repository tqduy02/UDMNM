        ...
        (r = function (e, t, n, i) {
          ...
          if ("undefined" == u || "function" == u) {
            for (
              ...
              if ("require" === (r = (s = h(t[a], d)).f)) c[a] = f.require(e);
      ...
      u.define("select2/results", ["jquery", "./utils"], function (d, p) {
        ...
        return (
          ...
          (i.prototype.option = function (e) {
            ...
            for (n in (((null != e.element && o.call(e.element, ":disabled")) ||
        ...
        function (e, t, r) {
          ...
          return (
            ...
            (n.prototype.query = function (t, n) {
              var i = this;
              null != this._request &&
                (r.isFunction(this._request.abort) && this._request.abort(),
                (this._request = null));
                ...
                var e = o.transport(
                  ...
                  function (e) {
                    ...
                    (i.options.get("debug") &&
                      window.console &&
                      console.error &&
                      ((e && e.results && r.isArray(e.results)) ||
                        console.error(
            ...
            (n.prototype.apply = function (e) {
              ...
              (null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter &&
                ...
                0 < e.minimumInputLength &&
                  (e.dataAdapter = m.Decorate(e.dataAdapter, $)),
                0 < e.maximumInputLength &&
                  (e.dataAdapter = m.Decorate(e.dataAdapter, A)),
                0 < e.maximumSelectionLength &&
                  (e.dataAdapter = m.Decorate(e.dataAdapter, x)),
                e.tags && (e.dataAdapter = m.Decorate(e.dataAdapter, w)),
                (null == e.tokenSeparators && null == e.tokenizer) ||
                  (e.dataAdapter = m.Decorate(e.dataAdapter, b)),
                null != e.query &&
                  ((t = a(e.amdBase + "compat/query")),
                  (e.dataAdapter = m.Decorate(e.dataAdapter, t))),
                null != e.initSelection &&
                  ((n = a(e.amdBase + "compat/initSelection")),
                  (e.dataAdapter = m.Decorate(e.dataAdapter, n)))),
                null == e.resultsAdapter &&
                  ((e.resultsAdapter = c),
                  null != e.ajax &&
                    (e.resultsAdapter = m.Decorate(e.resultsAdapter, E)),
                  null != e.placeholder &&
                    (e.resultsAdapter = m.Decorate(e.resultsAdapter, C)),
                  e.selectOnClose &&
                    (e.resultsAdapter = m.Decorate(e.resultsAdapter, q))),
                null == e.dropdownAdapter &&
                  (e.multiple
                    ? (e.dropdownAdapter = D)
                    : ((n = m.Decorate(D, S)), (e.dropdownAdapter = n)),
                  0 !== e.minimumResultsForSearch &&
                    (e.dropdownAdapter = m.Decorate(e.dropdownAdapter, T)),
                  e.closeOnSelect &&
                    (e.dropdownAdapter = m.Decorate(e.dropdownAdapter, j)),
                  (null == e.dropdownCssClass &&
                    null == e.dropdownCss &&
                    null == e.adaptDropdownCssClass) ||
                    ((i = a(e.amdBase + "compat/dropdownCss")),
                ...
                null == e.selectionAdapter &&
                  ...
                  (null == e.containerCssClass &&
                    ...
                    ((i = a(e.amdBase + "compat/containerCss")),
      ...
      (a = function (u) {
        ...
        function i(e) {
          ...
          if (
            ...
            "deltaX" in n && ((r = n.deltaX), 0 === s && (o = -1 * r)),
            0 !== s || 0 !== r)
          )
            return (
              1 === n.deltaMode
